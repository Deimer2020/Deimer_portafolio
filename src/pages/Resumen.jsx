        ...
        <main className="flex-shrink-0">
            ...
            <div className="container px-5 my-5">
                <div className="text-center mb-5">
                    <h1 className="display-5 fw-bolder mb-0"><span className="text-gradient d-inline">Resumen</span></h1>
                </div>
                                ...
                                <div className="card-body p-5">
                                    ...
                                    <div className="mb-5">
                                        <div className="d-flex align-items-center mb-4">
                                            ...
                                            <h3 className="fw-bolder mb-0"><span className="text-gradient d-inline">Habilidades Profesionales</span></h3>
                                        </div>
                                    ...
                                    <div className="mb-0">
                                        <div className="d-flex align-items-center mb-4">
                                            ...
                                            <h3 className="fw-bolder mb-0"><span className="text-gradient d-inline">Lenguajes</span></h3>
                                        </div>
                                        <div className="row row-cols-1 row-cols-md-3 mb-4">
